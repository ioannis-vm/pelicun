...
* Blocks are the number of independent units within a Performance
  ...
  determine the number of indepdendent blocks for each PG. See, for
  ...
  wall elements can get damaged indepdendently of the others.
...
The default FEMA P-58 damage process is farily simple. The process
...
that can be expanded with any aribtrary decision variable. Let us know
